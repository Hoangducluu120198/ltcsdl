...
namespace StaffManagement1.DB {
    ...
    public partial class DataSetNhanVien : global::System.Data.DataSet {
        ...
        public partial class NhanvienDataTable : global::System.Data.TypedTableBase<NhanvienRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public NhanvienRow AddNhanvienRow(int EmployeeID, string JobID, int DepartmentID, string LastName, string FirstName, string Gender, string CMND, string PhoneNumber, System.DateTime BirthDay, string Address, System.DateTime HireDay) {
        ...
        public partial class NhanvienRow : global::System.Data.DataRow {
            ...
            public int DepartmentID {
                get {
                    return ((int)(this[this.tableNhanvien.DepartmentIDColumn]));
                }
                set {
...
namespace StaffManagement1.DB.DataSetNhanVienTableAdapters {
    ...
    public partial class NhanvienTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Nhanvien] ([EmployeeID], [JobID], [DepartmentID], [LastName], [FirstName], [Gender], [CMND], [PhoneNumber], [BirthDay], [Address], [HireDay]) VALUES (@EmployeeID, @JobID, @DepartmentID, @LastName, @FirstName, @Gender, @CMND, @PhoneNumber, @BirthDay, @Address, @HireDay);
SELECT EmployeeID, JobID, DepartmentID, LastName, FirstName, Gender, CMND, PhoneNumber, BirthDay, Address, HireDay FROM Nhanvien WHERE (EmployeeID = @EmployeeID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Nhanvien] SET [EmployeeID] = @EmployeeID, [JobID] = @JobID, [DepartmentID] = @DepartmentID, [LastName] = @LastName, [FirstName] = @FirstName, [Gender] = @Gender, [CMND] = @CMND, [PhoneNumber] = @PhoneNumber, [BirthDay] = @BirthDay, [Address] = @Address, [HireDay] = @HireDay WHERE (([EmployeeID] = @Original_EmployeeID) AND ([JobID] = @Original_JobID) AND ([DepartmentID] = @Original_DepartmentID) AND ([LastName] = @Original_LastName) AND ([FirstName] = @Original_FirstName) AND ([Gender] = @Original_Gender) AND ([CMND] = @Original_CMND) AND ((@IsNull_PhoneNumber = 1 AND [PhoneNumber] IS NULL) OR ([PhoneNumber] = @Original_PhoneNumber)) AND ((@IsNull_BirthDay = 1 AND [BirthDay] IS NULL) OR ([BirthDay] = @Original_BirthDay)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_HireDay = 1 AND [HireDay] IS NULL) OR ([HireDay] = @Original_HireDay)));
SELECT EmployeeID, JobID, DepartmentID, LastName, FirstName, Gender, CMND, PhoneNumber, BirthDay, Address, HireDay FROM Nhanvien WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::StaffManagement1.Properties.Settings.Default.DBQuanLyNVConnectionString;
        }
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_JobID, int Original_DepartmentID, string Original_LastName, string Original_FirstName, string Original_Gender, string Original_CMND, string Original_PhoneNumber, global::System.Nullable<global::System.DateTime> Original_BirthDay, string Original_Address, global::System.Nullable<global::System.DateTime> Original_HireDay) {
            ...
            if ((Original_HireDay.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[14].Value = ((System.DateTime)(Original_HireDay.Value));
            }
            else {
        ...
        public virtual int Insert(int EmployeeID, string JobID, int DepartmentID, string LastName, string FirstName, string Gender, string CMND, string PhoneNumber, global::System.Nullable<global::System.DateTime> BirthDay, string Address, global::System.Nullable<global::System.DateTime> HireDay) {
        ...
        public virtual int Update(
            ...
            if ((Original_HireDay.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[25].Value = ((System.DateTime)(Original_HireDay.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    string Original_Address, 
                    global::System.Nullable<global::System.DateTime> Original_HireDay) {
            return this.Update(Original_EmployeeID, JobID, DepartmentID, LastName, FirstName, Gender, CMND, PhoneNumber, BirthDay, Address, HireDay, Original_EmployeeID, Original_JobID, Original_DepartmentID, Original_LastName, Original_FirstName, Original_Gender, Original_CMND, Original_PhoneNumber, Original_BirthDay, Original_Address, Original_HireDay);
        }
    }
